<template>
  <section>
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <!-- CTA box -->
      <div class="relative bg-gradient-to-tr from-green-2 rounded py-10 px-8 md:py-16 md:px-12 overflow-hidden" data-aos="zoom-out">
        ...
        <div class="hidden lg:block absolute right-0 top-1/2 -translate-y-1/2 mt-8 -z-10" aria-hidden="true">
            ...
            <defs><filter x="-37.5%" y="-37.5%" width="175%" height="175%" filterUnits="objectBoundingBox" id="b">
            <feGaussianBlur stdDeviation="50" in="SourceGraphic" />
            </filter><filter x="-37.5%" y="-37.5%" width="175%" height="175%" filterUnits="objectBoundingBox" id="c">
            <feGaussianBlur stdDeviation="50" in="SourceGraphic" /></filter><linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="a">
            <stop stop-color="#D8E4FF" stop-opacity="0" offset="0%" /><stop stop-color="#31E981" offset="100%" />
            </linearGradient></defs><g fill="none" fill-rule="evenodd">
            <circle fill-opacity="1" fill="url(#a)" filter="url(#b)" cx="314" cy="278" r="200" />
            <circle fill-opacity=".2" fill="#D8E4FF" filter="url(#c)" cx="518" cy="345" r="200" /></g></svg>
        </div>
        ...
        <div class="flex flex-col lg:flex-row justify-between items-center">
          ...
          <!-- CTA button -->
          <div class="shrink-0">
            <a class="btn text-gray-200 bg-gradient-to-t from-green-1 hover:to-purple-500 w-full group shadow-lg font-bold" href="learn">
