    ...
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-32 pb-12 md:pt-40 md:pb-20">
        ...
        <div class="max-w-xl mx-auto md:max-w-[640px] md:mx-0 text-center md:text-left">
          ...
          <h1 class="h1 font-uncut-sans mb-6" data-aos="zoom-out" data-aos-delay="100">The MEV marketplace for <em class="font-italic">seachers</em> and <em class="font-italic">protocols</em></h1>
          <p class="text-xl text-gray-400 mb-10" data-aos="zoom-out" data-aos-delay="200"></p>
          <div class="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4" data-aos="zoom-out" data-aos-delay="300">
            <div>
              <a class="btn text-white bg-gradient-to-t from-blue-600 to-blue-400 hover:to-blue-500 w-full shadow-lg group" href="#0">
                Become a Searcher <span class="tracking-normal text-blue-200 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1"></span>
              </a>
            </div>
            <div>
              <a class="btn text-gray-300 bg-gradient-to-t from-gray-800 to-gray-700 hover:to-gray-800 w-full shadow-lg" href="#0">Hire a Searcher</a>
            </div>
          </div>
