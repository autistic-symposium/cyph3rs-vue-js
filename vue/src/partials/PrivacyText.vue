...
<template>
  <section class="relative overflow-hidden">
    ...
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
     ...
     <!-- Section header -->
        <div class="text-align pb-12 md:pb-20 text-gray-300">
          <h2 class="h2 font-uncut-sans" data-aos="zoom-out">Searchers Market Privacy Policy</h2>
        </div>


         <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
            <p class="text-lg text-gray-400 text-align font-bold pb-12">
            ...
            sites we own and operate.This policy is effective as of 14 December 2022 and was last updated on 14 December 2022.
            </p>
        

        <h4 class="h4 text-gray-200 text-align pb-12">Information We Collect</h4>
        ...
        <h4 class="h4 text-gray-200 text-align pb-12">Log Data</h4>
        ...
        <h4 class="h4 text-gray-200 text-align pb-12">Collection and Use of Information</h4>

        <p class="text-lg text-gray-400 text-align font-bold pb-12">
        We may collect personal information from you when you do any of the following on our website:

        <br>
        Use a mobile device or web browser to access our content. Contact us via email, social media, or on any similar 
        technologies. When you mention us on social media. We may collect, hold, use, and disclose information for the 
        following purposes, and personal information will not be further processed in a manner that is incompatible with 
        these purposes. Please be aware that we may combine information we collect about you with general information or 
        research data we receive from other trusted sources.
        </p>

        <h4 class="h4 text-gray-200 text-align pb-12">Security of Your Personal Information</h4>
        ...
        no method of electronic transmission or storage is 100% secure, and no one can guarantee absolute data security. 
        ...
        <h4 class="h4 text-gray-200 text-align pb-12">How Long We Keep Your Personal Information</h4>
        ...
        <h4 class="h4 text-gray-200 text-align pb-12">Children’s Privacy</h4>
        ...
        <h4 class="h4 text-gray-200 text-align pb-12">International Transfers of Personal Information</h4>
        <p class="text-lg text-gray-400 text-align font-bold pb-12">
        ...
        <h4 class="h4 text-gray-200 text-align pb-12">Your Rights and Controlling Your Personal Information</h4>
        <p class="text-lg text-gray-400 text-align font-bold pb-12">
        ...
        <h4 class="h4 text-gray-200 text-align pb-12">Limits of Our Policy</h4>
        <p class="text-lg text-gray-400 text-align font-bold pb-12">
        ...
        <h4 class="h4 text-gray-200 text-align pb-12">Changes to This Policy</h4>
        <p class="text-lg text-gray-400 text-align font-bold pb-12">
        ...
        <h4 class="h4 text-gray-200 text-align pb-12">Contact Us</h4>
        <p class="text-lg text-gray-400 text-align font-bold pb-12">
