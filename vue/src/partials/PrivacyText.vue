    ...
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-32 pb-12 md:pt-40 md:pb-20">
        ...
        <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <h4 class="h4 text-gray-200  pb-12">Information We Collect</h4>
          ...
          <h4 class="h4 text-gray-200  pb-12">Log Data</h4>
          ...
          <h4 class="h4 text-gray-200  pb-12">Collection and Use of Information</h4>

          <p class="text-lg text-gray-400  font-bold pb-12">
            We may collect personal information from you when you do any of the following on our website:

            <br><br>
            Use a mobile device or web browser to access our content. Contact us via email, social media, or on any
            similar
            technologies. When you mention us on social media. We may collect, hold, use, and disclose information for
            the
          ...
          <h4 class="h4 text-gray-200  pb-12">Security of Your Personal Information</h4>

          <p class="text-lg text-gray-400  font-bold pb-12">

            When we collect and process personal information, and while we retain this information,
            we will protect it within commercially acceptable means to prevent loss and theft, as well as
            unauthorized access, disclosure, copying, use, or modification.

            <br><br>

            Although we will do our best to protect the personal information you provide to us, we advise that
            no method of electronic transmission or storage is 100% secure, and no one can guarantee absolute data
            security.
          ...
          <h4 class="h4 text-gray-200  pb-12">How Long We Keep Your Personal Information</h4>
          ...
          <h4 class="h4 text-gray-200  pb-12">Children’s Privacy</h4>
          ...
          <h4 class="h4 text-gray-200  pb-12">International Transfers of Personal Information</h4>
          <p class="text-lg text-gray-400  font-bold pb-12">
            The personal information we collect is stored and/or processed where we or our partners, affiliates, and
            third-party
            providers maintain facilities. Please be aware that the locations to which we store, process, or transfer
            your personal
            information may not have the same data protection laws as the country in which you initially provided the
            information.

            <br><br>
            If we transfer your personal information to third parties in other countries: (i) we will perform those
            transfers in
          ...
          <h4 class="h4 text-gray-200  pb-12">Your Rights and Controlling Your Personal Information</h4>
          <p class="text-lg text-gray-400  font-bold pb-12">
            You always retain the right to withhold personal information from us, with the understanding that your
            experience of
            our website may be affected. We will not discriminate against you for exercising any of your rights over
            your personal
            information. If you do provide us with personal information you understand that we will collect, hold, use
            and disclose
            it in accordance with this privacy policy. You retain the right to request details of any personal
            information we hold
            about you.
            <br><br>
            ...
            privacy policy.
            If you are a third party providing personal information about somebody else, you represent and warrant that
            you have
            ...
            change your
            mind at any time. We will provide you with the ability to unsubscribe from our email-database or opt out of
            ...
            misleading,
            please contact us using the details provided in this privacy policy. We will take reasonable steps to
            correct any
            ...
            contact us
            using the details below and provide us with full details of the alleged breach. We will promptly investigate
            your
            complaint and respond to you, in writing, setting out the outcome of our investigation and the steps we will
            take to
            deal with your complaint. You also have the right to contact a regulatory body or data protection authority
            in relation
            to your complaint.
            <br><br>
          </p>
          ...
          <h4 class="h4 text-gray-200  pb-12">Limits of Our Policy</h4>
          <p class="text-lg text-gray-400  font-bold pb-12">


            Our website may link to external sites that are not operated by us. Please be aware that we have no control
            over the
            content and policies of those sites, and cannot accept responsibility or liability for their respective
            privacy
            practices.
            <br><br>
          </p>
          ...
          <h4 class="h4 text-gray-200  pb-12">Changes to This Policy</h4>
          <p class="text-lg text-gray-400  font-bold pb-12">

            At our discretion, we may change our privacy policy to reflect updates to our business processes, current
            acceptable
            practices, or legislative or regulatory changes. If we decide to change this privacy policy, we will post
            the changes
          ...
          <p class="text-lg text-gray-400  font-bold pb-12">
            For any questions or concerns regarding your privacy, you may contact us using the following email:
            hello@cyph3rs.xyz.
          </p>
