        ...
        <div>
          ...
          <div class="max-w-sm mx-auto sm:max-w-none grid gap-12 sm:grid-cols-7 md:grid-cols-7 sm:gap-x-7 sm:gap-y-8">
            ...
            <a class="block relative p-5 group" href="https://docs.cyph3rs.xyz/">
              ...
              <div class="text-xl text-gray-100 font-bold">Docs</div>
            </a>
            ...
            href="https://t.me/searchers_market">
              ...
              <div class=" text-xl text-gray-100 font-bold">Telegram</div>
            </a>

            <!-- 2nd Box -->
            <a class="block relative p-5 group" 
            href="https://discord.gg/WUzhur787m">
              <div class="relative h-12 w-12 rounded-full bg-gradient-to-t from-gray-800 to-gray-700 flex items-center justify-center shadow-lg mb-3 ">
                <svg class="fill-green-400 group-hover:fill-gray-200 transition duration-150 ease-in-out" width="24" height="18" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="font-sora text-xl text-gray-100 font-bold">Discord</div>
            </a>
            ...
            <svg class="fill-green-400 group-hover:fill-gray-200 transition duration-150 ease-in-out" width="22" height="22" xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="font-sora text-xl text-gray-100 font-bold">Twitter</div>
            </a>
            ...
            <a class="block relative p-5 group" href="https://github.com/withCyph3rs">
              ...
              <div class=" text-xl text-gray-100 font-bold">GitHub</div>
            </a>
            ...
            <a class="block relative p-5 group" href="https://www.youtube.com/@cyph3rs" >
              ...
              <div class="text-xl text-gray-100 font-bold">YouTube</div>
            </a>
