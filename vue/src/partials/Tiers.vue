<template>
  <section class="relative">
    ...
    <!-- Illustration -->
    <div class="hidden lg:block absolute bottom-0 left-1/2 -translate-x-1/2 pointer-events-none -z-10"
      aria-hidden="true">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20 border-t border-gray-800">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          ...
          <div class="max-w-2xl mx-auto">
            <p class="text-xl text-gray-400 font-bold">
              ...
              protocol, Cyph3rs is the community for you.
          </p>
          </div>
        ...
        <div class="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none pt-4">
          ...
          <!-- ----------------- -->
          <!-- ----------------- -->
          <div class="relative flex flex-col h-full p-6 bg-gray-800 rounded py-10 px-8" data-aos="zoom-out"
            data-aos-delay="100">
            <div class="absolute top-0 left-0 mr-6 -mt-4">
              <div
            ...
            <ul class="text-gray-400 space-y-3 grow">
              <li class="flex items-center">
                ...
                <span>Understand MEV extraction, actors, and current landscape</span>
              </li>
              <li class="flex items-center">
                <svg class="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12"
                  xmlns="http://www.w3.org/2000/svg">
                ...
                <span>Bootstrap your bot from dozens of templates</span>
              </li>
              <li class="flex items-center">
                <svg class="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12"
                  xmlns="http://www.w3.org/2000/svg">
                ...
                <span>Learn how to design profitable strategies on your favorite chain</span>
              </li>
              <li class="flex items-center">
                <svg class="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12"
                  xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="relative flex flex-col h-full p-6 bg-gray-800 rounded py-10 px-8 " data-aos="zoom-out"
            ...
            <ul class="text-gray-400 space-y-3 grow">
              <li class="flex items-center">
                ...
                <span>Gain access to strategies research and
              ...
              <li class="flex items-center">
                ...
                <span>Browse bounties where we'll match you to projects</span>
              </li>
              <li class="flex items-center">
                <svg class="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12"
                  xmlns="http://www.w3.org/2000/svg">
                ...
                <span>Connect with other searchers and earn coins from sharing your XP</span>
              </li>
              <li class="flex items-center">
                <svg class="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12"
                  xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="relative flex flex-col h-full p-6 bg-gray-800 rounded py-10 px-8" data-aos="zoom-out"
            ...
            <div class="mb-6">
              ...
              <div class="text-gray-400 mb-6 font-bold">
                DeFi projects that are delivering solutions for fair MEV extraction.
              </div>
            ...
            <ul class="text-gray-400 space-y-3 grow">
              ...
              <li class="flex items-center">
                ...
                <span>Safely connect with a network of searchers and builders</span>
              </li>
              <li class="flex items-center">
                <svg class="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12"
                  xmlns="http://www.w3.org/2000/svg">
                ...
                <span>Hire experienced operators and recruit customized searchers</span>
              </li>
              <li class="flex items-center">
                <svg class="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12"
                  xmlns="http://www.w3.org/2000/svg">
                ...
                <span>Run competitions, post grants, and build community</span>
              </li>
              <li class="flex items-center">
                <svg class="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12"
                  xmlns="http://www.w3.org/2000/svg">
                ...
                <span>Get the latest updates and news on the MEV space</span>
              </li>
