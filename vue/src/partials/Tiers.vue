        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          ...
          <div class="max-w-2xl mx-auto">
            <p class="text-xl text-gray-400 font-bold">
              Whether you are starting the MEV game or you are an experienced searcher operator, joining CYPH3RS will level up your game
            </p>
          </div>
          ...
          <div class="relative flex flex-col h-full p-6 bg-gray-800 rounded py-10 px-8" data-aos="zoom-out"
            ...
            <ul class="text-gray-400 space-y-3 grow">
              ...
              <li class="flex items-center">
                ...
                <span>Boostrap your bot from dozens of templates</span>
              </li>
              <li class="flex items-center">
                <svg class="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12"
                  xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="relative flex flex-col h-full p-6 bg-gray-800 rounded py-10 px-8 " data-aos="zoom-out"
            ...
            <ul class="text-gray-400 space-y-3 grow">
              <li class="flex items-center">
                ...
                <span>Access to strategies research and
              ...
              <li class="flex items-center">
                ...
                <span>Browse bounties and get matched to projects</span>
              </li>
              <li class="flex items-center">
                <svg class="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12"
                  xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="relative flex flex-col h-full p-6 bg-gray-800 rounded py-10 px-8" data-aos="zoom-out"
            ...
            <ul class="text-gray-400 space-y-3 grow">
              ...
              <li class="flex items-center">
                ...
                <span>Stay updated with the latest news in the MEV space</span>
              </li>
