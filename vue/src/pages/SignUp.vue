              ...
              <div class="py-16 md:py-20">
                  ...
                  <div class="space-y-4">
                    ...
                    <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                      ...
                      <div class="sm:w-1/2">
                        ...
                        <input id="surname" class="form-input py-2 w-full" type="text" required />
                      </div>
                    </div>
                    <div>
                ...
                <div class="pt-4 border-t border-gray-800">
                  <div class="text-sm text-gray-400">
                    Already have an account? <router-link class="font-medium text-blue-500 hover:text-blue-400" to="/signin">Sign In</router-link>
                  </div>
                </div>
